          ...
          {data.map((medicalCenter, index) => (
            <tr key={medicalCenter.id}>
              ...
              <td className='text-center'>
                {medicalCenter.addresses.length > 0 ?  (medicalCenter.addresses.map((address, index) => {
                  if (index === 0) {
              ...
              <td className='text-center'>
                {medicalCenter.emails.length > 0 ?  (medicalCenter.emails.map((email, index) => {
                    if (index === 0) {
                      return email.value;
                    }
                 })) : (
              ...
              <td className='text-center'>
                {medicalCenter.phones.length > 0 ? (medicalCenter.phones.map((phone, index) => {
                    if (index === 0) {
                      return phone.number;
                    }
                 })) : (
