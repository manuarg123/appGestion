...
public class SocialWorkDTO extends PersonDTO {
    ...
    public SocialWorkDTO(List<AddressDTO> addressDTOS, List<PhoneDTO> phoneDTOS, List<EmailDTO> emailDTOS, List<IdentificationDTO> identificationDTOS) {
        super(addressDTOS, phoneDTOS, emailDTOS, identificationDTOS);
    }
    public SocialWorkDTO() {
        super();
    }
    public SocialWorkDTO(List<AddressDTO> addressDTOS, List<PhoneDTO> phoneDTOS, List<EmailDTO> emailDTOS, List<IdentificationDTO> identificationDTOS, @NotNull(message = "Name cannot be null") String name) {
        super(addressDTOS, phoneDTOS, emailDTOS, identificationDTOS);
        this.name = name;
    }
}